...
export default function AboutSection() {
    ...
    return (
        ...
        >
            ...
            <div className="mx-auto mt-10 sm:mt-8 flex w-full max-w-7xl flex-1 flex-col justify-center gap-14 md:gap-18 text-rame-sabbia text-[0.8rem] sm:text-sm md:text-md lg:text-lg xl:text-xl 2xl:text-2xl">
                <motion.p
